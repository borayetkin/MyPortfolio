...
import "../styles/BlogPage.css"; // Importing CSS
import blogData from "../data/blogData.json"; // Importing JSON data
import firstBlogImage from "../assets/images/background.jpg"; // Import images
